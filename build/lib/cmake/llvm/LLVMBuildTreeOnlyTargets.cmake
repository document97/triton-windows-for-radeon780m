...
set_target_properties(FileCheck PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_TRITON_LLVM_SDK_ROOT}/bin/FileCheck.exe"
  )
...
set_target_properties(llvm-PerfectShuffle PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_TRITON_LLVM_SDK_ROOT}/bin/llvm-PerfectShuffle.exe"
  )
...
set_target_properties(count PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_TRITON_LLVM_SDK_ROOT}/bin/count.exe"
  )
...
set_target_properties(not PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_TRITON_LLVM_SDK_ROOT}/bin/not.exe"
  )
...
set_target_properties(UnicodeNameMappingGenerator PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_TRITON_LLVM_SDK_ROOT}/bin/UnicodeNameMappingGenerator.exe"
  )
...
set_target_properties(yaml-bench PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_TRITON_LLVM_SDK_ROOT}/bin/yaml-bench.exe"
  )
...
set_target_properties(split-file PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_TRITON_LLVM_SDK_ROOT}/bin/split-file.exe"
  )
...
set_target_properties(lli-child-target PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_TRITON_LLVM_SDK_ROOT}/bin/lli-child-target.exe"
  )
...
set_target_properties(llvm-jitlink-executor PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_TRITON_LLVM_SDK_ROOT}/bin/llvm-jitlink-executor.exe"
  )
...
set_target_properties(obj2yaml PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_TRITON_LLVM_SDK_ROOT}/bin/obj2yaml.exe"
  )
...
set_target_properties(yaml2obj PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_TRITON_LLVM_SDK_ROOT}/bin/yaml2obj.exe"
  )
...
set_target_properties(KillTheDoctor PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_TRITON_LLVM_SDK_ROOT}/bin/KillTheDoctor.exe"
  )
